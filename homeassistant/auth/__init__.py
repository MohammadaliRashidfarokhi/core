...
class AuthManager:
    ...
    async def async_create_refresh_token(
        ...
        resolved_type = self._resolve_token_type(user, token_type)
        self._validate_user_and_client(user, resolved_type, client_id, client_name)
        self._ensure_unique_llat(user, client_name, resolved_type)
        expire_at = self._compute_expire_at(resolved_type)
    ...
    @staticmethod
    def _resolve_token_type(user: models.User, token_type: str | None) -> str:
    ...
    @staticmethod
    def _compute_expire_at(token_type: str) -> float | None:
        return (
    ...
    @staticmethod
    def _ensure_unique_llat(
        user: models.User, client_name: str | None, token_type: str
    ) -> None:
