...
from homeassistant.const import CONF_LATITUDE, CONF_LONGITUDE,SENSOR_MDI_GAUGE, SENSOR_WEATHER_WINDY, SENSOR_COMAPASS_OUTLINE, WEATHER_POURING_OUTLINE, WEATHER_PARTLY_CLOUDY_OUTLINE
